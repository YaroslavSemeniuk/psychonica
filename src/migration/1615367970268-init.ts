...
export class init1615367970268 implements MigrationInterface {
    name = 'init1615367970268'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
      ...
      await queryRunner.query('CREATE TABLE "article" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "seoId" character varying NOT NULL, "title" character varying NOT NULL DEFAULT \'\', "description" character varying NOT NULL DEFAULT \'\', "descriptionHtml" character varying, "imgSrc" character varying(700), "gender" "article_gender_enum" NOT NULL, "userId" uuid NOT NULL, "categoriesIds" text array NOT NULL, CONSTRAINT "UQ_cf0dd95232eca5b6afe2a64e872" UNIQUE ("seoId"), CONSTRAINT "UQ_fca3cb9ba4963678f564f22e7a8" UNIQUE ("title"), CONSTRAINT "PK_40808690eb7b915046558c0f81b" PRIMARY KEY ("id"))');
      await queryRunner.query('CREATE TABLE "category" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "seoId" character varying NOT NULL, "title" character varying NOT NULL, "description" character varying, "articleId" uuid, CONSTRAINT "UQ_2951da6f23cc7940f6a1c8547b3" UNIQUE ("seoId"), CONSTRAINT "UQ_9f16dbbf263b0af0f03637fa7b5" UNIQUE ("title"), CONSTRAINT "PK_9c4e4a89e3674fc9f382d733f03" PRIMARY KEY ("id"))');
